...
\section{Participation citoyenne}
	...
	\subsection{Projets}
		...
		\subsubsection{FreshWater Watch}
			...
			\begin{figure}
				\begin{center}
					\includegraphics[width=300pt]{ecosystem-flowchart.png}
				\end{center}
		...
		\subsubsection{NAWMS}
			...
			Le NAWMS est un système de surveillance de la consommation de l'eau qui est non intrusif et autonome pour sa calibration. 
