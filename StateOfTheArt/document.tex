	...
	\subsection{Projets}
		...
		\subsubsection{NAWMS}
			...
			\begin{figure}
				...
				\end{center}
				\caption{Calibration du NAWMS (source : \cite{kim_nawms:_2008})}
			\end{figure}
